...
<div id="content" class="span10">
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('manage/slider') ?>">Manage Slider</a></li>
    </ul>
                    ...
                    <tbody>
                        ...
                        foreach ($all_slider as $single_slider) {
                            ...
                            <tr>
                                ...
                                <td class="center"><a class="btn btn-primary" href="<?php echo $single_slider->slider_btn_link; ?>"><?php echo $single_slider->slider_btn_text; ?></a></td>
