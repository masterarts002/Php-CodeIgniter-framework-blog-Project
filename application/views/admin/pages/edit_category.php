    ...
    <div class="row-fluid">
        <div class="box span12">
            ...
            <div class="box-content">
                <form class="form-horizontal" action="<?php echo base_url('update/category/'.$category_info_by_id->id);?>" method="post" enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <div class="control-group">
                            <label for="textarea2">Category Description</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <input class="span6 typeahead" name="category_delete_image" value="<?php echo base_url('uploads/'.$category_info_by_id->category_image);?>" type="hidden"/>
                            </div>
                        </div>
                        
                        <div class="control-group">
                            <div class="controls">
                                <img src="<?php echo base_url('uploads/'.$category_info_by_id->category_image);?>" style="width:500px;height:200px"/>
                            </div>
                        </div> 
