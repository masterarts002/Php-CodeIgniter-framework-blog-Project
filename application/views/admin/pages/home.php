<div id="content" class="span10">
    ...
    <div class="row-fluid">		
        <div class="box span12">
            ...
            <div class="box-content"   style="overflow-x:auto !important;">
                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo $i;?></td>
                            <td class="center"><?php echo $single_post->post_title;?> 
                            <span class="badge badge-info"><i class="icon-comments" aria-hidden="true"></i>  <?php
                            $this->db->select();
                            $this->db->from('cmt_table');
                            $this->db->where('cmt_post_id', $single_post->post_slug);
                            $info = $this->db->get();
                            echo $info->num_rows();
                            ?> </span><br>
